...
class TelaNivel3(TelaJogo):
    def __init__(self, jogo):
        ...
        self.barra_vida = BarraVida(jogo, self.jogo.state['livros_atingidos'], 15, TelaNivel4)
...
class TelaNivel3(TelaJogo):
    def __init__(self, jogo):
        ...
        self.barra_vida = BarraVida(jogo, self.jogo.state['livros_atingidos'], 15, Win)
